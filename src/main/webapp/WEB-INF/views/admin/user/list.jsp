...
<div class="main-content">
    <form action="<c:url value='/quan-tri/thanh-vien/danh-sach'/>" id="formSubmit" method="get">
                            ...
                            <div class="table-btn-controls">
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <c:url value='/quan-tri/thanh-vien/chinh-sua' var="createNewUrl"/>
                                        <a flag="info"
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>${item.fullName}</td>
                                                <td>
                                                    <c:url var="updateNewUrl" value="/quan-tri/thanh-vien/chinh-sua">
